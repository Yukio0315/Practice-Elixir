defmodule Issues.TableFormatter do
  ...
  That is, each header identifies a column, and those columns are extracted and printed from the rows.0
  ...
  The 'header' parameter contains the list of columns to extract
  ...
  @doc """
  Given a list containing sublists, where each sublist contains the data fore a column,
